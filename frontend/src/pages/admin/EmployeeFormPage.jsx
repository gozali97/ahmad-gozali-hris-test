...
export function EmployeeFormPage() {
  ...
  useEffect(() => {
    ...
    if (isEdit) {
      ...
      employeeService
        ...
        .catch(() => {
          toast.error("Gagal men-generate NIP otomatis.");
        })
        .finally(() => setIsFetching(false));
    }
  }, [id, isEdit, navigate]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (serverErrors) {
        // Konversi error array dari Laravel menjadi string tunggal
      ...
      toast.error(
        err.response?.data?.message ||
          "Gagal menyimpan data. Periksa kembali isian form Anda.",
      );
    } finally {
      setIsLoading(false);
    }
